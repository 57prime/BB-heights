...
4. 根据Theorem 5.59与Theorem 5.63, 我们可以计算$\delta(\mathfrak{C})$和$\varphi(\mathfrak{C})$。在Theorem 5.65中，我们将计算结果汇总并计算出曲线$\mathfrak{C}$的Gross-Schoen cycle的高。在5.9节我们验证了计算过程中的结果具有较好的稳定性并且与相关文献中的已知结果相容。
